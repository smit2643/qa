...
from models.test_run import BrowserType
...
class TestResult(UUIDMixin, TimestampMixin, Base):
    ...
    status: Mapped[ResultStatus] = mapped_column(SAEnum(ResultStatus), default=ResultStatus.pending, nullable=False, index=True)
